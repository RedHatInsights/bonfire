...
def reserve_namespace(name, requester, duration, pool_type, timeout, local=True):
    ...
    res_config = process_reservation(name, requester, duration, pool_type, local=local)
